...
public class Magpie4
{
	...
	{
		System.out.println("Hint: If you are stuck, try typing \"I want your brownies!\"\n");
	...
	public String getResponse(String statement)
	{
				...
				|| findKeyword(statement, "cat") >= 0)
		{
			...
			response = "I've heard of him. He's awesome.";
				...
				|| findKeyword(statement, "cuz") >= 0
				|| findKeyword(statement, "cus ") >= 0)
		{
			response = "I don't need an explanation.";
				...
				|| findKeyword(statement, "ni hao") >= 0) 
		{
	...
	private String transformIWantStatement(String statement)
	{
		...
		//changes you to me and your to my *English convention
		if (findKeyword(restOfStatement, "you", 0) >= 0) {
			restOfStatement = restOfStatement.substring(0, findKeyword(restOfStatement, "you", 0))
					+ "me" + restOfStatement.substring(findKeyword(restOfStatement, "you", 0) + 3);
		} else if (findKeyword(restOfStatement, "your", 0) >= 0) {
				restOfStatement = restOfStatement.substring(0, findKeyword(restOfStatement, "your", 0))
						+ "my" + restOfStatement.substring(findKeyword(restOfStatement, "your", 0) + 4);
		}
