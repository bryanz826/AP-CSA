...
import com.state.levels.Level02;
import com.state.levels.Level03;
import com.state.levels.Level04;
import com.state.levels.Level05;
import com.state.levels.Level06;
import com.utils.Reference;
import com.utils.Resource;

/**
 * Load all of the resources for the game.
 * @author bryan
 */
public class SplashScreen
{
	...
	/**
	 * Builds the States class to load all the states
	 * @see States
	 */
	private States	sm	= new States();
	...
	public SplashScreen()
	{
		...
		sm.addState(new Menu());
		sm.addState(new Level00());
		sm.addState(new Level01());
		sm.addState(new Level02());
		sm.addState(new Level03());
		sm.addState(new Level04());
		sm.addState(new Level05());
		sm.addState(new Level06());
