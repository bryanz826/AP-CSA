...
import pong5.Ball5;
import pong5.Paddle5;

//import java.awt.event.ActionListener;

public class Pong5 extends Canvas implements KeyListener, Runnable
{
	...
	public Pong5()
	{
		...
		//set up variables
		leftPaddle = new Paddle5(10, 244, 10, 70, Color.YELLOW, 4);
		rightPaddle = new Paddle5(760, 244, 10, 70, Color.YELLOW, 4);
		wall = new Wall5(0, 770, 10, 550);
		keys = new boolean[4];
		leftScore = 0;
		rightScore = 0;
